...
const EmployeesProfile = ({ params }: GetSingleEmployeeParmsType) => {
  ...
  const { employeeProfileData, employeeProfileIsLoading, employeeProfileIsError, employeeProfileError, employeeProfileIsSuccess } = crudState;


  useEffect(() => {
    getEmployeeProfileData({ id })(crudDispatch);
  }, [id]);
